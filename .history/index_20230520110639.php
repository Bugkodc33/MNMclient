...
<div class="row">
	<div class="col-md-4 col-md-offset-3">
		<div class="well" style="position:relative; left:50% ;transform: translate(-30%);
		top:90% ">
		<center>
			<h2 style="margin-top:1px; font-size:20px ; ">Hệ Thống Quản Lý Công Việc Nhân Viên</h2>
	</center>
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  <div class="form-heading" style="color:green">
			    <h2 class="text-center"  style="font-size: 15px"> Tài Khoản </h2>
			  </div>
			  ...
			  <div class="form-group">
			    <input type="text" class="form-control" placeholder="Vui Lòng Nhập Tài Khoản" name="username" required/>
			  </div>
			  <div class="form-group" ng-class="{'has-error': loginForm.password.$invalid && loginForm.password.$dirty, 'has-success': loginForm.password.$valid}">
			    <input type="password" class="form-control" placeholder="Vui Lòng Nhập Mật Khẩu" name="admin_password" required/>
			  </div>
