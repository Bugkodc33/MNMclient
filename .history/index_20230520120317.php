    ...
    margin-bottom: 30px;"> Quản Lý Công Việc Nhân Viên</h2>
			...
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  ...
			  <div class="form-group">
			    <input type="text" class="form-control" placeholder="Vui Lòng Nhập Tài Khoản" name="username" required maxlength="15"/>
			  </div>
			  <div class="form-group" ng-class="{'has-error': loginForm.password.$invalid && loginForm.password.$dirty, 'has-success': loginForm.password.$valid}">
			    <input type="password" class="form-control" placeholder="Vui Lòng Nhập Mật Khẩu" name="admin_password" required maxlength="15"/>
			  </div>
