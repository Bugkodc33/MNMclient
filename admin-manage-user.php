              ...
              <form role="form" action="" method="post" autocomplete="off">
                <div class="form-horizontal">
                  ...
                  <div class="form-group">
                    <label class="control-label col-sm-4">Tên Đầy Đủ</label>
                    <div class="col-sm-6">
                      <input type="text" placeholder="Vui Lòng Nhập " name="em_fullname" list="expense" class="form-control input-custom" id="default" required>
                    </div>
                  </div>
                   <div class="form-group">
                    <label class="control-label col-sm-4">Tên</label>
                    <div class="col-sm-6">
                      <input type="text" placeholder="Vui Lòng Nhập " name="em_username" class="form-control input-custom" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="control-label col-sm-4">Thư Điện Tử</label>
                    <div class="col-sm-6">
                      <input type="email" placeholder="Vui Lòng Nhập Thư Điện Tử" name="em_email" class="form-control input-custom" required>
                    </div>
                  </div>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-3 col-sm-3">
                      <button type="submit" name="add_new_employee" class="btn btn-success-custom">Thêm</button>
                    </div>
                    <div class="col-sm-3">
