                          ...
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            ...
                            <div class="form-group">
                              <div class="col-sm-offset-4 col-sm-3">
                                <button type="submit" name="update_current_employee" class="btn btn-success-custom">Cập Nhật</button>
                              </div>
                            </div>
                          </form> 
                        </div>
                        <div class="col-md-5">
                          <button id="emlpoyee_pass_btn" class="btn btn-primary">Thay Đổi Mật Khẩu</button>
                          <form action="" method="POST" id="employee_pass_cng">
                            ...
                            <div class="form-group">
                              <button type="submit" name="btn_user_password" class="btn btn-success">Đồng Ý</button>
